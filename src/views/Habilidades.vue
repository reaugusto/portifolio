<template>
    ...
    <div class="row justify-content-center mt-5">
        <div class="col-lg-10 d-flex programacao justify-content-evenly">
            ...
            <div class="svg">
                <svg viewBox="0 0 128 128" @click="activated($event),  visivel = 2">
            ...
            <div class="svg">
                <svg viewBox="0 0 128 128" @click="activated($event),  visivel = 3">
...
<script>
    export default {
        ...
        methods:{
            //seleciona o SVG clicado e adiciona as classes de elemento ativo
            activated(event){
                if(this.activeSVG !== null){
                    this.activeSVG.path[1].classList.remove('activ');
                    this.activeSVG.path[1].parentNode.children[1].classList.remove('AcBorder');
                }
                 event.path[1].classList.add('activ');
                 event.path[1].parentNode.children[1].classList.add('AcBorder')
                 this.activeSVG = event;
            }
        }
    }
</script>
<style scoped>
    ...
    .activ{
        filter: drop-shadow(5px 5px 12px rgb(255, 243, 136));
    }
